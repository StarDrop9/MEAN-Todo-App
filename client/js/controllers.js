todoApp.controller('TodoCtrl', function($rootScope, $scope, todosFactory) {
  ...
  $scope.isEditable = [];
  $scope.rowLimit = 3 ;
  $scope.priorities= [{priority:"Action" },{priority:"High"},{priority:"Medium"},{priority:"Low"},{priority:"Completed"}];
  $scope.label = "Label Todo | Idea!";
  ...
  $scope.save = function($event,label, priority) {
   debugger; // Set the debugger inside 
    ...
    if ( $event.which == 13 && $scope.todoInput || $scope.todoInput ) {
