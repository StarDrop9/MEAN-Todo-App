...
$scope.labels = [{ label: "Magnetism" }, { label: "Splitting Water" }, { label: "Tech Scouting"}, { label: "Free Energy"}, { label: "Design"},{ label: "Coding"},{ label: "Health"}, { label: "Survival Training"}]
